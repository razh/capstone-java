...
public class SimplexNoise {
	...
	public static double noise(double xin, double yin, double zin) {
		...
		/*
			A step of (1, 0, 0) in (i, j, k)
			means a step of (1 - c, -c, -c) in (x, y, z),
			a step of (0, 1, 0) in (i, j, k)
			means a step of (-c, 1 - c, -c) in (x, y, z), and
			a step of (0, 0, 1) in (i, j, k)
			means a step of (-c, -c, 1 - c) in (x, y, z), where
			c = 1 / 6.
		*/
